...
namespace PressureGaugeCodeGeneratorTestWpf
{
    public partial class MainWindow : Window
    {
        ...
        private void ComboBoxFormatSelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
        ...
        #region Допилить автоматическую установку года
        /// <summary>Допилить автоматическую установку года</summary>
